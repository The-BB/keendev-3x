...
$settings['services']['pidFiles'] = array(
	...
	'Cron' => '/opt/var/run/cron.pid',
	'Crond' => '/opt/var/run/crond.pid',
	'Dropbear' => '/opt/var/run/dropbear.pid',
	'Lighttpd' => '/opt/var/run/lighttpd.pid',
	'Nginx' => '/opt/var/run/nginx.pid',
	'vnStat' => '/opt/var/run/vnstat.pid'
);
...
// for details, see ./src/Linfo/Extension/Apcaccess.php
$settings['extensions']['apcaccess'] = false;

// for details, see ./src/Linfo/Extension/Cups.php
$settings['extensions']['cups'] = false;

// for details, see ./src/Linfo/Extension/Dnsmas_dhcpd.php
$settings['extensions']['Dnsmasq_dhcpd'] = false;
$settings['dnsmasq_hide_mac'] = true;
$settings['dnsmasq_leases'] = '/opt/var/lib/dnsmasq.leases';

// for details, see ./src/Linfo/Extension/Smb.php
