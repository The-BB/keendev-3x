...
<head>
<?php if (!isset($codepage)) { $codepage='UTF-8'; } ?>
<meta http-equiv="Content-Type" content="text/html;charset=<?php echo $codepage; ?>"/>
...
<body class="body">
<div class="leaf">
<div class="leaf_head"><?php $header ??= ''; echo $header; ?></div>
<?php
$descript ??= '';
if ($descript != '')
{
	echo "<div class='leaf_info'>".$descript."</div>";
}
?>
<div class="leaf_page">
