...
INSTALLER=$SCRIPT_DIR/mips-installer.tar.gz
...
cp -r $SCRIPT_DIR/locale-archive.2.27-mips $ROOT_DIR/opt/usr/lib/locale/locale-archive
...
cp -r $BUILD_DIR/pcre2-*/ipkg-mips-3.4/libpcre2/opt $ROOT_DIR
